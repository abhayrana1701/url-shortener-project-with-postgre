...
const shortenUrl = async (req, res) => {
    ...
    try {
        ...
        const newUrl = await (0, url_service_1.createShortUrl)(originalUrl, expirationDate, userId);
...
const redirectUrl = async (req, res) => {
    ...
    try {
        ...
        const url = await (0, url_service_1.findOriginalUrl)(hash);
        if (!url) {
        ...
        await (0, url_service_1.trackAnalytics)(url.id, ipAddress, userAgentString);
...
const getUrlAnalyticsController = async (req, res) => {
    ...
    try {
        ...
        const analyticsResult = await (0, url_service_1.getUrlAnalytics)(hash);
...
const getUserUrlsController = async (req, res) => {
    ...
    try {
        ...
        const userUrls = await (0, url_service_2.getUserUrls)(userId);
...
const deleteUrlController = async (req, res) => {
    ...
    try {
        ...
        const result = await (0, url_service_2.deleteUrl)(hash);
